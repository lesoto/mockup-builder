    ...
    <footer className="bg-dark text-light">
      <div className="row p-2 p-sm-4 footer-row mx-auto">
        <div className="col-12 col-md-7">
          <h2>Join Now</h2>
          <p>
            We hope you got some useful information and have decided which one you will choose. You can enrol with our
            courses if you think so. Best of luck for your learning!
          </p>
        </div>
        <div className="col-12 col-md-5 text-center my-4">
          ...
          <p className="my-2">Copyright &copy; 2022</p>
        </div>
      </div>
    </footer>
  );
  ...
  return (
    <footer className="bg-dark text-light">
      <div className="row p-4 footer-row mx-auto">
        ...
        <p className="w-100 text-center mt-2">Copyright &copy; 2022</p>
      </div>
    </footer>
  );
}
      ...
      <div className="pt-12 lg:pt-16">
        <div className="max-w-screen-2xl px-4 md:px-8 mx-auto">
          ...
          <div className="text-gray-400 text-sm text-center border-t py-8">
            © 2022 - Present Flowrift. All rights reserved.
          </div>
        </div>
      </div>
    </footer>
    ...
    <footer className="max-w-screen-2xl px-4 md:px-8 mx-auto">
      <div className="flex flex-col md:flex-row justify-between items-center border-t border-b gap-4 py-6">
        <nav className="flex flex-wrap justify-center md:justify-start gap-x-4 gap-y-2 md:gap-6">
          <a href="/" className="text-gray-500 hover:text-indigo-500 active:text-indigo-600 transition duration-100">
            About
          </a>
          <a href="/" className="text-gray-500 hover:text-indigo-500 active:text-indigo-600 transition duration-100">
            Investor Relations
      ...
      <div className="text-gray-400 text-sm text-center py-8">© 2022 All rights reserved.</div>
    </footer>
  );
}
