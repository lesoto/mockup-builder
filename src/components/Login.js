...
export const LoginOne = () => {
  return (
    <div className="login_form border-2 border-indigo-500 p-10 pt-5 shadow-sm mx-auto flex rounded">
      <div className="sec flex-1">
        <img className="mb-3 mx-auto" src="images/World-Wide01.jpg" alt="" />
        <span className="flex shadow-md mb-5 text-xs">
          <span className="bg-indigo-500 w-28 font-bold text-center text-gray-200 p-3 px-5 rounded-l">Email</span>
          <input
        ...
        <span className="flex shadow-md mb-5 text-xs">
          <span className="bg-indigo-500 w-28 font-bold text-center text-gray-200 p-3 px-5 rounded-l">Password</span>
          <input className="field text-sm text-gray-600 p-2 px-3 rounded-r w-full" type="password" placeholder="" />
        </span>
        <a className="text-indigo-500 hover:underline font-bold text-xs ml-auto cursor-pointer" href="/">
          Forget Password ?
        </a>
