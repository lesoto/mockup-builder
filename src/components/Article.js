      ...
      <div className="row">
        ...
        <div className="col-12 col-md-8 align-self-center px-2">
          ...
          <p className="text-break">
            ...
            such as desktop computers, mobile phones to promote products and services.
          </p>
          <p className="text-break hidden-p">
  ...
  return (
    <div className="section-03">
      <div className="text-center p-3 my-md-3 border border-danger text-danger">
        ...
        <p>
          Web development is the work involved in developing a website for the Internet or an intranet. Sign up now and
          start your journey.
        </p>
      </div>
      ...
      <div className="text-center p-3 my-md-3 border border-secondary text-secondary">
        ...
        <p>
          {' '}
          Video editing is used to structure and present all video information, including films and television shows and
