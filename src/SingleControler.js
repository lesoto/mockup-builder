...
export default class SingleControler extends Component {
  ...
  render() {
    ...
    let classes = show
      ? 'col-3 fas fa-1x fa-angle-up align-self-center'
      : 'col-3 fas fa-1x fa-angle-down align-self-center';
    return (
              ...
              return (
                <div className="col-6 text-center" key={index}>
                  <p
                    className={
                      color === el
                        ? 'bg-danger border border-danger rounded py-0 py-md-1'
                        : 'text-light border border-light rounded py-0 py-md-1'
                    }
                    style={{ cursor: 'pointer' }}
                    onClick={() => this.props.componentFun(this.props.name, el)}
                  >
                    {el}
                  </p>
                </div>
